        ...
        <Card className="max-w-4xl mx-auto">
          <CardContent className="p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {['packages', 'hotels', 'flights', 'transport'].map(type => <Button key={type} variant={searchType === type ? 'default' : 'outline'} onClick={() => setSearchType(type)} className="flex-1 min-w-[120px]">
                  {t(`home.search.${type}`)}
                </Button>)}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Input placeholder={t('home.search.destinationPlaceholder')} value={destination} onChange={e => setDestination(e.target.value)} />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !departureDate && "text-muted-foreground", isRTL && "text-right")}>
