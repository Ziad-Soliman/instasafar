...
const TestimonialsSection = () => {
  ...
  return <section className="py-16 bg-muted/10">
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          <h2 className="text-3xl font-bold mb-4 text-center">{t('home.testimonials.title')}</h2>
          <p className="text-muted-foreground text-lg text-center">{t('home.testimonials.subtitle')}</p>
        </motion.div>
