...
const ExpandableChatToggle: React.FC<ExpandableChatToggleProps> = ({
  ...
  <Button
    ...
    onClick={toggleChat}
    className={cn(
      "w-14 h-14 rounded-full shadow-saudi hover:shadow-saudi-lg flex items-center justify-center transition-all duration-300 transform hover:-translate-y-0.5",
      className,
    )}
    {...props}
  >
