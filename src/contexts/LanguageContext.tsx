...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'packages.description': 'Discover our carefully curated packages for Hajj, Umrah, and cultural tours across Saudi Arabia',
    ...
    'search.loadMore': 'Load More Packages',
    'dashboard.fromLastMonth': 'from last month',
    'admin.totalUsersDesc': 'Active users on platform',
    'admin.totalBookingsDesc': 'All time bookings',
    'admin.totalRevenueDesc': 'Total platform revenue',
    'admin.totalHotelsDesc': 'Listed hotels',
    'admin.totalPackagesDesc': 'Available packages',
    'admin.pendingBookingsDesc': 'Awaiting approval',
    'footer.description': 'Your trusted partner for Hajj, Umrah, and travel experiences across Saudi Arabia. Book with confidence and create unforgettable memories.',
  ...
  ar: {
    ...
    'packages.description': 'اكتشف باقاتنا المختارة بعناية للحج والعمرة والجولات الثقافية في جميع أنحاء المملكة العربية السعودية',
    'packages.availablePackages': 'الباقات المتاحة',
    'search.priceLowToHigh': 'السعر: من الأقل إلى الأعلى',
    'search.priceHighToLow': 'السعر: من الأعلى إلى الأقل',
    'search.loadMore': 'تحميل المزيد من الباقات',
    'dashboard.fromLastMonth': 'من الشهر الماضي',
    'admin.totalUsersDesc': 'المستخدمون النشطون على المنصة',
    'admin.totalBookingsDesc': 'جميع الحجوزات',
    'admin.totalRevenueDesc': 'إجمالي إيرادات المنصة',
    'admin.totalHotelsDesc': 'الفنادق المدرجة',
    'admin.totalPackagesDesc': 'الباقات المتاحة',
    'admin.pendingBookingsDesc': 'في انتظار الموافقة',
    'footer.description': 'شريكك الموثوق للحج والعمرة وتجارب السفر في جميع أنحاء المملكة العربية السعودية. احجز بثقة واصنع ذكريات لا تُنسى.',
    ...
    'common.cookies': 'سياسة ملفات تعريف الارتباط',
  }
};
