...
export const englishTranslations: TranslationRecord = {
  ...
  'footer.tagline': 'Your trusted partner for Hajj and Umrah journeys, committed to making your spiritual experience memorable and comfortable.',
  ...
  'footer.transportServices': 'Transport Services',
  'footer.faqs': 'FAQs',
  'footer.visaInfo': 'Visa Information',
  'footer.termsAndConditions': 'Terms & Conditions',
  'footer.privacyPolicyLink': 'Privacy Policy',
  'footer.newsletter': 'Newsletter',
  'footer.newsletterTagline': 'Subscribe to receive updates on new packages and offers.',
  'footer.yourEmail': 'Your email',
  'footer.subscribe': 'Subscribe',
  'footer.providerPortal': 'Provider Portal',
  'footer.copyright': '© {year} InstaSafar. All rights reserved.',
  'footer.address': '123 Business Avenue, Makkah, Saudi Arabia',
